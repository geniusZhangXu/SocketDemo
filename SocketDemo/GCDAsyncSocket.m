...
//用一个dispatch_queue_t去初始化
-(id)initWithSocketQueue:(dispatch_queue_t)sq
{
	return [self initWithDelegate:nil delegateQueue:NULL socketQueue:sq];
}

//用代理和代理开的dispatch_queue_t初始化
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -----------------  Accepting 这部分代码服务端使用 ----------
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 也有助于了解一下服务端的accept()原理
// 监听端口起点
 ...
 * 
**/
//在连接之前的接口检查，一般我们传nil  interface 本机的IP 端口等等
                ...
                error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		{
		        // 要是前置检查的结果是YES,就不会进这个，要是是NO就在这里返回
                        return_from_block;
		}
		// 通过了所有的检查
...
// 直接连接到一个addr的data
// 连接到给定的地址，指定为包含在NSData对象中的sockaddr结构。
...
- (int)createSocket:(int)family connectInterface:(NSData *)connectInterface errPtr:(NSError **)errPtr
{
    ...
    // 防止终止进程的信号？
    int nosigpipe = 1;
    // SO_NOSIGPIPE是为了避免网络错误，而导致进程退出。用这个来避免系统发送signal，防止网络不好的时候Crash
		...
		if (bytesRead > 0)
		{
			...
			else if (currentRead->term != nil)
			{
				...
				if (readIntoPreBuffer)
				{
					...
					uint8_t *readBuf = (uint8_t *)[currentRead->buffer mutableBytes] + currentRead->startOffset + currentRead->bytesDone;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 下面这句话意思是让你看头文件，嗯，那就去看头文件关于这个方法的讨论。下面的几个方法都是见头文件！
/**
